...
(setq package-list '(ack-and-a-half auctex puppet-mode apache-mode dsvn whitespace php-mode markdown-mode python-mode js2-mode yasnippet color-theme-solarized git-commit))
