...
(setq package-list '(ack-and-a-half puppet-mode apache-mode dsvn whitespace php-mode markdown-mode python-mode js2-mode yasnippet color-theme-solarized coffee-mode rvm handlebars-mode))
